...
## 魔改版
本程序是基于南科大Tis选课助手进行修改的，主要优化了原来多线程报错问题以及修改Class.txt编码问题。
原版本链接，南科大Tis选课助手（https://github.com/GhostFrankWu/SUSTech_Tools）
...
- 如果您本地没有python环境，您可以[使用windows打包版](https://github.com/Seraphimara/SUSTech_Class_Selection/releases/tag/V1.0)  
